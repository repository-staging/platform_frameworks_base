 ...
 *   For the primary SP itself, stored under NULL_PROTECTOR_ID:
 ...
 *
 *     For each primary and secondary protector, stored under the corresponding protector ID:
